...
import deco2800.spooky.renderers.Renderable;
...
public abstract class AbstractEntity implements Comparable<AbstractEntity>, Renderable {
	 ...
	 * @param renderOrder the render order of this entity
     */
	...
	/**
	 * Constructor for an abstract entity
	 * @param col he col position on the world
	 * @param row the row position on the world
	...
	public void dispose() {
		GameManager.get().getManager(ServerManager.class).deleteEntity(this);
