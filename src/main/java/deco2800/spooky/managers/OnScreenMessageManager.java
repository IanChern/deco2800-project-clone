...
import deco2800.spooky.observers.KeyTypedObserver;

import java.util.ArrayList;
import java.util.List;

public class OnScreenMessageManager implements KeyTypedObserver, AbstractManager {
