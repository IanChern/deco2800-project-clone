...
public final class DatabaseManager implements AbstractManager {
    ...
    private static final String ERRORSTRING = "Cannot read the tile json array";
    ...
    private static AbstractEntity resolveEntityToLoad(String entityObjectName) {
        try {
            ...
            fullEntityName.append("deco2800.spooky");
    ...
    private static boolean startArrayReading(com.google.gson.stream.JsonReader reader,
        ...
        try {
            ...
            logger.error("Couldn't read from JSON Reader");
            return false;
        }
    }
