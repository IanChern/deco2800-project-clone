...
@PrepareForTest({GameManager.class, DatabaseManager.class})
public class SaveLoadTest {
    ...
    public void SetMapTest() {
        ...
        deco2800.spooky.managers.DatabaseManager.saveWorld(w);
        
        
        TestWorld q = new TestWorld();
        deco2800.spooky.managers.DatabaseManager.loadWorld(q);
